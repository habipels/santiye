...
#    #taşeron olayları#
    ...
    path("control/rapor_onaylama/<str:hash>", views.rapor_onaylama_2, name="rapor_onaylama_2"),
    path("applygeneralreport/<int:id>", views.genel_rapor_onaylama, name="genel_rapor_onaylama"),
    path("control/applygeneralreport/<int:id>/<str:hash>", views.genel_rapor_onaylama_2, name="genel_rapor_onaylama_2"),
...
path("rfi_silme/", views.rfi_silme, name="rfi_silme"),
