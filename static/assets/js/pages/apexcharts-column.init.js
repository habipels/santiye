function getChartColorsArray(e) {
    if (null !== document.getElementById(e) && (e = document.getElementById(e).getAttribute("data-colors")))
...
function updateQuarterChart(e, t) {
    ...
    if (e.w.globals.selectedDataPoints[0]) {
        for (var a = e.w.globals.selectedDataPoints, s = 0; s < a[0].length; s++) {
            ...
            o.push({ name: n.data[l].x, data: n.data[l].quarters }), r.push(n.data[l].color);
        }
        return 0 === o.length && (o = [{ data: [] }]), ApexCharts.exec(t, "updateOptions", { series: o, colors: r, fill: { colors: r } });
    }
}
var chart,
    optionsGroup,
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function (e, t, o) {
                    ...
                    1 !== o.selectedDataPoints[0].length || r.classList.contains("active") || (a.classList.add("chart-quarter-activated"), r.classList.add("active")),
                        updateQuarterChart(t, "barQuarter"),
                        0 === o.selectedDataPoints[0].length && (a.classList.remove("chart-quarter-activated"), r.classList.remove("active"));
                },
                updated: function (e) {
